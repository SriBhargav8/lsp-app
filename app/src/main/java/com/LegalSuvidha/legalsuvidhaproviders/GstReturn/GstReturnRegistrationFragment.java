...
public class GstReturnRegistrationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_gst_return_registration, container, false);
        ...
        typeList.add("Upto 20");
        typeList.add("Upto 100");
        typeList.add("Upto 500");
        typeList.add("Upto 1000");
        typeList.add("Above 1000");
        ...
        businessTypeTV.setText("GST Return Filing");
        businessDescTV.setText((R.string.GST_Return_Registration));

        title_on_appbar.setText("GST Return Filing");
...
//        registrationType =  getActivity().getIntent().getStringExtra("typeOfRegistration");
    ...
    public void goToConfirmPhoneNumber(View view) {
        ...
        if (!validateFullName() | !validateEmail() | !validatePhoneNumber() | !validateType()) {
            return;
        }
...
//        if(user != null){
        ...
        profile.put("ServiceType", serviceType+": " + type);
...
//            bundle.putString("BusinessType", "type");
