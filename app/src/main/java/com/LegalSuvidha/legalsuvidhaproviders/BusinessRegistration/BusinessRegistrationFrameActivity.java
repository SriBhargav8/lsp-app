...
public class BusinessRegistrationFrameActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Business Registration");
...
//        toggle.syncState();
        ...
        if(savedInstanceState==null) {
            ...
            String registrationType= getIntent().getStringExtra("typeOfBusiness");
//            Log.i("typeOfRegistration","typeOfRegistration "+ registrationType);
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_containerFrameActivity,businessRegistrationFragment).setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE).commit();
...
//                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new HomeFragment()).setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE).commit();
            ...
            case R.id.gst_registration:
                Intent intentGst= new Intent(this, GstRegistrationActivity.class);
...
//                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new TypesOfGstRegistrationFragment()).setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE).commit();
            ...
            case R.id.gst_validator:
                ...
                Intent intentValidation= new Intent(this, GstValidatorActivity.class);
...
//                Intent intentFree= new Intent(this, GstValidatorActivity.class);
...
//                Intent intentBR= new Intent(this, BusinessRegistrationActivity.class);
...
//                    getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new TypesOfBusinessRegistration()).setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE).commit();
            ...
            case R.id.mandatory_annual_compliance:
                Intent intentM= new Intent(BusinessRegistrationFrameActivity.this, MandatoryComplianceActivity.class);
...
//                    getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new TypesOfBusinessRegistration()).setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE).commit();
            ...
            case R.id.blogs:
                Intent intentBlog= new Intent(BusinessRegistrationFrameActivity.this, BlogsActivity.class);
